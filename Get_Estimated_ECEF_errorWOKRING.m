...
ff = 0;   %offset to sync estimated and real ECI values (517 good)
...
error_a = a_est - ephsat(1);   %in m
error_e = e_est - ephsat(2);
error_i = i_est - ephsat(3);
error_Omega = Omega_est - ephsat(4);
error_omega = omega_est - ephsat(5);
error_M = M_est - ephsat(6);
