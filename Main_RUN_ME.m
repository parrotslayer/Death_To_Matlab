...
Feature_ECI_true = NaN(3,time_period);
Nadir_ECEF_true = NaN(time_period,3);
Feature_ECI_est = NaN(3,time_period);
Feature_ECEF_est = NaN(time_period,3);
Feature_LGCV_est = NaN(time_period,3);
Feature_RAE_est = NaN(time_period,3);
Feature_Body_est = NaN(time_period,3);
Nadir_Body_est = NaN(time_period,3);
Nadir_LGCV_est = NaN(time_period,3);
